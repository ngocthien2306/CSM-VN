"""
modeling_csm.py - CSM Model Implementation

Based on Sesame's CSM architecture with modifications for Vietnamese.
This is adapted from the original CSM code in the documents.
"""
    ...
    def __init__(
        ...
        backbone_config=LlamaConfig(
            ...
            rope_scaling={
                ...
                "original_max_position_embeddings": 1024,  # FIXED: 1024 < 2048
            },
        ...
        decoder_config=LlamaConfig(
            ...
            rope_scaling={
                ...
                "original_max_position_embeddings": 16,  # FIXED: 16 < 32
            },
            architectures=["LlamaForCausalLM"],
            hidden_act="silu",
        ),
...
class CSMModel(PreTrainedModel):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            if backbone_loss.dim() > 0:
                backbone_loss = backbone_loss.mean()
            if decoder_loss.dim() > 0:
